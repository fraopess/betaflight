...
const char * const debugModeNames[DEBUG_COUNT] = {
    ...
    [DEBUG_RANGEFINDER_ESP32CAM] = "RANGEFINDER_ESP32CAM",
    ...
    [DEBUG_OPTICAL_FLOW] = "OPTICAL_FLOW",
    [DEBUG_POSHOLD_STICKS] = "POSHOLD_STICKS",
    [DEBUG_OF_HOLD] = "OF_HOLD",
    [DEBUG_ALT_HOLD] = "ALT_HOLD",
};
