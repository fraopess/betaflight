...
#define PG_ESP32_HYBRID_CONFIG 62  // ESP32 hybrid sensor (rangefinder + optical flow)
#define PG_MTF02_HYBRID_CONFIG 63  // MTF-02 hybrid sensor (rangefinder + optical flow)
...
#define PG_OF_POSHOLD_CONFIG        561
